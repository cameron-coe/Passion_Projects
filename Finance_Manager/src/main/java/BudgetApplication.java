...
public class BudgetApplication {
    ...
    public void run () {
        ...
        groceries.setupRecurringTransactionNoEndDate(1, "W", startDate);
        ...
        paycheck.setupRecurringTransactionNoEndDate(2, "W", startDate);

        BudgetItem bonus = new BudgetItem("Monthly Bonus", mainJob);
        bonus.setTransactionAmount(500);
        bonus.setupRecurringTransactionNoEndDate(1, "M", startDate);
        ...
        test7.setupRecurringTransactionNoEndDate(1, "D", startDate);


        BudgetItem miscExpenses = new BudgetItem("Mics. Expenses", budgetManager.getRootBudgetItem());
        paycheck.setupRecurringTransactionNoEndDate(12, "M", LocalDate.parse("2024-01-01"));
